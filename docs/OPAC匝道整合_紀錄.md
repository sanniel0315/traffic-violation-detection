...
> 站點兩相（2026-09-17 確認）：分相1 下匝道（儲車600m，主線保護優先）、分相2 上匝道（儲車210m）。
...
## 二、中心端部署（10.200.38.35）

| 項目 | 內容 |
|---|---|
| 主機 | `10.200.38.35`，Ubuntu x86_64（**非 Jetson**），跑 k8s |
...
```yaml
aicctv:
  base-url: "http://10.200.40.21:8000"   # 我方 Jetson
  api-key:  "tvd_<API_KEY>"
