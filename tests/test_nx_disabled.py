...
（10.201.4.123:7001），/api/nx/devices 要 **60 秒**才回 502 ——
...
ON = {"enabled": True, "server_base_url": "https://10.201.4.123:7001", "proxy_base_url": ""}
OFF = {"enabled": False, "server_base_url": "https://10.201.4.123:7001", "proxy_base_url": ""}
...
check("其他欄位沒被影響",
      _normalize_nx_settings(OFF)["server_base_url"], "https://10.201.4.123:7001")
