...
來源:號誌控制器 RS-232 → Moxa MiiNePort E1 → TCP。現場實測參數:
    IP 10.200.38.35   TCPDataPort 1001   Mode TCP / Role TCP Server   MaxConnect 1
...
SIGNAL_HOST = os.getenv("SIGNAL_TC3_HOST", "10.200.38.35")
...
# 🛑 為什麼需要:10.200.38.35 這個 IP 在現場兩個網段各有一台設備(號誌模組
